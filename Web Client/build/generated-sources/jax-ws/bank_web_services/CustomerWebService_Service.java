 ...
 * 
 */
@WebServiceClient(name = "CustomerWebService", targetNamespace = "http://bank_web_services/", wsdlLocation = "http://localhost:8080/Web_Service/CustomerWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERWEBSERVICE_QNAME = new QName("http://bank_web_services/", "CustomerWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Web_Service/CustomerWebService?wsdl");
    ...
    public CustomerWebService getCustomerWebServicePort() {
        return super.getPort(new QName("http://bank_web_services/", "CustomerWebServicePort"), CustomerWebService.class);
    }
    ...
    public CustomerWebService getCustomerWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bank_web_services/", "CustomerWebServicePort"), CustomerWebService.class, features);
    }
